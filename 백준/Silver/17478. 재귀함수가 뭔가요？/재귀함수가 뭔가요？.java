...
public class Main {
    ...
    static void recursive(int n, String under) {
        if(n == 0) {
            System.out.println(under + s2);
            System.out.println(under + s6);
            System.out.println(under + s7);
            return;
        }
        System.out.println(under + s2);
        System.out.println(under + s3);
        System.out.println(under + s4);
        System.out.println(under + s5);
        recursive(n-1, under + "____");
        System.out.println(under + s7);
    }
}
